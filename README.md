...
| [Federal Reserve Bank of Kansas City](https://www.kansascityfed.org/research/research-working-papers/)                                 | roundup_scripts/scrapers/Fed_KansasCity.py     | Reads main landing page using Requests and parses with BeautifulSoup. Extracts data from each individual WP's landing page using Ruests and BeautifulSoup    |
